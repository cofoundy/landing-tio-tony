      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-32 md:px-8">
        <div className="max-w-xl">
          <div className="rounded-3xl bg-black/25 p-6 backdrop-blur-sm md:bg-black/15 md:p-8 md:backdrop-blur-md">
            ...
            <div className="hero-animate hero-animate-delay-3 mt-6 flex flex-col gap-3 sm:flex-row">
              <a
                href="https://wa.me/51928561078?text=Hola%2C%20quiero%20hacer%20un%20pedido"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-whatsapp px-7 py-3.5 text-base font-bold text-white shadow-xl transition-transform hover:scale-105 hover:bg-whatsapp-dark"
              >
              ...
              <a
                href="#menu"
                className="inline-flex items-center justify-center rounded-full border-2 border-white/30 px-7 py-3.5 text-base font-bold text-white transition-colors hover:border-accent hover:text-accent"
              >
                Ver menú ↓
              </a>
            </div>
