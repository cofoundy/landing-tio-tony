...
export default function CtaBanner() {
  return (
    <section className="relative overflow-hidden bg-primary py-16 md:py-20">
      {/* Decorative circles */}
      <div className="pointer-events-none absolute -left-20 -top-20 h-60 w-60 rounded-full bg-white/10" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center md:px-8">
        ...
        <p className="mx-auto mt-4 max-w-xl font-body text-lg text-white/80">
          Escríbenos por WhatsApp y te tenemos tu pedido listo cuando llegues.
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 font-body text-base font-bold text-primary shadow-xl transition-transform hover:scale-105"
          >
