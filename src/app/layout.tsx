...
export const metadata: Metadata = {
  ...
  description:
    "Desayunos nutritivos, jugos naturales y combos desde S/2.00. Av. José Olaya, El Tambo — Huancayo. Abierto de lunes a sábado, 7AM a 6PM.",
  keywords: [
    "juguería Huancayo",
    "desayunos El Tambo",
  ...
  openGraph: {
    ...
    description:
      "Desayunos nutritivos, jugos naturales y combos desde S/2.00 en El Tambo, Huancayo.",
    type: "website",
    locale: "es_PE",
    images: [
      {
